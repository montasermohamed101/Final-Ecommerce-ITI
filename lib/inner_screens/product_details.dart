              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _details(themeState.darkTheme, 'Type: ', prodAttr.type),
                      _details(themeState.darkTheme, 'Size: ',
                          '${prodAttr.size}'),
                      _details(themeState.darkTheme, 'Color: ',
                          '${prodAttr.color}'),
                ...
                Container(
                  ...
                  child: ListView.builder(
                    itemCount:
                    productsList.length < 4 ? productsList.length : 4,
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        favsProvider.addAndRemoveFromFav(productId,
                            prodAttr.price, prodAttr.type, prodAttr.imageUrl);
                      },
                      child: Center(
                        child: Icon(
