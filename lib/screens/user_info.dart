...
class _UserInfoState extends State<UserInfo> {
  ...
  void getData() async {
    ...
    if (userDoc == null) {
      ...
      setState(() {
        _fname = userDoc.get('fname');
        _lname = userDoc.get('lname');
        _email = user.email;
              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    userListTile('First Name', _fname ?? '', 5, context),
                    userListTile('Last Name', _lname ?? '', 5, context),
                    userListTile('Email', _email ?? '', 0, context),
                    userListTile('Phone', _phoneNumber.toString() ?? '',
                        1, context),
